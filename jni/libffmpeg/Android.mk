...
#LOCAL_MODULE := ffmpeg_no_neon
LOCAL_MODULE := ffmpeg

#SUPPORT_NEON := false
SUPPORT_NEON := true

NDK := /Users/stainberg/Develop/android/android-ndk-r8e
ANDROID_LIBS := ../android-libs
ABI := "armeabi-v7a"

# manual support HAVE_PTHREADS options added by xjm
# if support HAVE_THREADS,must one of HAVE_PTHREADS,HAVE_W32THREADS,HAVE_OS2THREADS is true in config.h by 
# manual set (because configure --enable-pthreads option cann't does work ),and set one to 'yes' in this .mk file
# android only a partial implementation pthreads,such as thread_cancel,so HAVE_PTHREAD_CANCEL is 0 
HAVE_PTHREADS := yes
# $(info XJM debug: HAVE_PTHREADS = $(HAVE_PTHREADS))

include $(LOCAL_PATH)/config.mak

#LOCAL_C_INCLUDES += /Users/sarah/Develop/Trip/lib_ffmpeg_V3/jni/android-source/frameworks/base/include \
					/Users/sarah/Develop/android/android-ndk-r8e/sources/cxx-stl/stlport/stlport \
					/Users/sarah/Develop/Trip/lib_ffmpeg_V3/jni/android-source/system/core/include \
					/Users/sarah/Develop/Trip/lib_ffmpeg_V3/jni/android-source/hardware/libhardware/include \
					/Users/sarah/Develop/Trip/lib_ffmpeg_V3/jni/android-source/frameworks/native/include \
					/Users/sarah/Develop/Trip/lib_ffmpeg_V3/jni/android-source/frameworks/native/include/media/openmax \
					/Users/sarah/Develop/Trip/lib_ffmpeg_V3/jni/android-source/frameworks/av/include \
					/Users/sarah/Develop/Trip/lib_ffmpeg_V3/jni/android-source/frameworks/base/native/include \
					/Users/sarah/Develop/Trip/lib_ffmpeg_V3/jni/android-source/frameworks/base/include/media/stagefright/openmax \

#LOCAL_C_INCLUDES += $(LOCAL_PATH)/../include

LOCAL_CFLAGS += -D_STLP_USE_NEWALLOC
										
$(info XJM debug: TARGET_ARCH_ABI = $(TARGET_ARCH_ABI))
...
#        LOCAL_CFLAGS += -DHAVE_NEON=1
	    ...
	    # in config.h file 's HAVE_NEON must set 0
...
ifeq ($(TARGET_ARCH_ABI),armeabi-v7a)
	...
	LOCAL_CFLAGS += -marm #-march=armv7-a -mtune=cortex-a8 
endif

#ifeq ($(HAVE_ARMV6),yes)
#    $(info XJM debug: AVCODEC_ARM_C_FILE HAVE_ARMV6 = $(HAVE_ARMV6))
#endif
...
AVCODEC_C_FILES-$(CONFIG_LIBSTAGEFRIGHT_H264_DECODER)+= libstagefright.cpp
...
# so that aacpsdsp_init_arm.c、dsputil_init_neon.c、sbrdsp_init_arm.c need change
# see code
...
$(AVFORMAT_SRC_FILES)    \
$(SWSCALE_SRC_FILES)     \
$(SWRESAMPLE_SRC_FILES)
 
LOCAL_ARM_MODE := arm

EXTRA_CXXFLAGS="-Wno-multichar -fno-exceptions -fno-rtti"

#LOCAL_LDLIBS := -lcutils -lutils -lbinder -lvorbisidec -lsonivox -lmedia -lcamera_client -landroid_runtime -lstagefright -lstagefright_omx -lstagefright_foundation -lgui -ldl
 
LOCAL_LDLIBS := -llog
 
# $(info XJM debug: LOCAL_ARM_MODE = $(LOCAL_ARM_MODE))
