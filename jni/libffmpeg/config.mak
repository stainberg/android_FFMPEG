...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-static --enable-asm --cpu=cortex-a8 --arch=armv7 --enable-neon --disable-shared --enable-gpl --enable-version3 --enable-nonfree --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-avdevice --disable-swresample --disable-postproc --disable-avfilter --disable-encoders --disable-hwaccels --disable-muxers --disable-indevs --disable-outdevs --disable-devices --disable-filters --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=ac3 --enable-decoder=mp3 --enable-decoder=mpeg1video --enable-decoder=mpeg2video --enable-decoder=mpeg4 --enable-decoder=mpegvideo --enable-decoder=amrnb --enable-decoder=amrwb --enable-decoder=h264 --disable-parsers --enable-parser=aac --enable-parser=mpegvideo --enable-parser=aac_latm --enable-parser=ac3 --enable-parser=h264 --enable-parser=mpeg4video --enable-parser=mpegaudio --disable-demuxers --enable-demuxer=aac --enable-demuxer=ac3 --enable-demuxer=amr --enable-demuxer=rawvideo --enable-demuxer=latm --enable-demuxer=rtp --enable-demuxer=rtsp --enable-demuxer=sdp --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=mpegts --enable-demuxer=mpegvideo --enable-demuxer=g722 --enable-demuxer=g723_1 --enable-demuxer=g729 --enable-demuxer=h264 --enable-demuxer=hls --disable-protocols --enable-protocol=file --enable-protocol=http --enable-protocol=tcp --enable-protocol=udp --enable-protocol=rtp --enable-protocol=applehttp --enable-protocol=hls --disable-debug --cross-prefix=/home/stainberg/linux/android-ndk-r8/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi- --enable-cross-compile --target-os=linux --extra-cflags='-I$PLATFORM/usr/include -mfpu=neon -mfloat-abi=softfp' --extra-ldflags='-L$PLATFORM/usr/lib -nostdlib'
prefix=/usr/local
...
ARCH=arm
CC=/home/stainberg/linux/android-ndk-r8/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
CXX=/home/stainberg/linux/android-ndk-r8/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-g++
AS=/home/stainberg/linux/android-ndk-r8/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
LD=/home/stainberg/linux/android-ndk-r8/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
DEPCC=/home/stainberg/linux/android-ndk-r8/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
YASM=yasm
YASMDEP=yasm
AR=/home/stainberg/linux/android-ndk-r8/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-ar
RANLIB=/home/stainberg/linux/android-ndk-r8/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-ranlib
CP=cp -p
LN_S=ln -sf
STRIP=/home/stainberg/linux/android-ndk-r8/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-strip
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC
CFLAGS= -I/usr/include -mfpu=neon -mfloat-abi=softfp -mcpu=cortex-a8 -std=c99 -fomit-frame-pointer -fPIC -marm -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS= -I/usr/include -mfpu=neon -mfloat-abi=softfp -mcpu=cortex-a8 -fPIC
AS_O=-o $@
CC_O=-o $@
CXX_O=-o $@
...
LAVFI_TESTS=crop crop_scale crop_scale_vflip crop_vflip drawbox fade life null overlay pad pixfmts_copy pixfmts_crop pixfmts_hflip pixfmts_null pixfmts_pad pixfmts_pixdesctest pixfmts_scale pixfmts_vflip scale200 scale500 select setdar setsar testsrc thumbnail transpose unsharp vflip vflip_crop vflip_vflip 
