...
//    __android_log_print(ANDROID_LOG_VERBOSE, "utils", "ff_read_frame_flush");
                                 ...
                                 int stream_index, int64_t timestamp, int flags)
{
    ...
    AVStream *st;
    AVIndexEntry *ie;
    __android_log_print(ANDROID_LOG_VERBOSE, "seek_frame_generic", "seek_frame_generic");
    st = s->streams[stream_index];
                               ...
                               int64_t timestamp, int flags)
{
    int ret;
    AVStream *st;
//    __android_log_print(ANDROID_LOG_VERBOSE, "utils", "seek_frame_internal");
    if (flags & AVSEEK_FLAG_BYTE) {
        if (s->iformat->flags & AVFMT_NO_BYTE_SEEK)
            return -1;
//        __android_log_print(ANDROID_LOG_VERBOSE, "seek_frame_internal", "ff_read_frame_flush 1");
        ff_read_frame_flush(s);
    ...
    AV_NOWARN_DEPRECATED(
    if (s->iformat->read_seek) {
//    	__android_log_print(ANDROID_LOG_VERBOSE, "seek_frame_internal", "ff_read_frame_flush 2");
        ff_read_frame_flush(s);
...
//    	__android_log_print(ANDROID_LOG_VERBOSE, "seek_frame_internal", "ff_read_frame_flush 3");
        ff_read_frame_flush(s);
        return ff_seek_frame_binary(s, stream_index, timestamp, flags);
    } else if (!(s->iformat->flags & AVFMT_NOGENSEARCH)) {
//    	__android_log_print(ANDROID_LOG_VERBOSE, "seek_frame_internal", "ff_read_frame_flush 4");
//        ff_read_frame_flush(s);
...
{
//	__android_log_print(ANDROID_LOG_VERBOSE, "utils", "av_seek_frame 1");
