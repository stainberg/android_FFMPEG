...
//#define _DEBUG_ANDROID_
#ifdef _DEBUG_ANDROID_
#define TAG "mpegts"
#include "../libmediaplayer/androidlog.h"
#endif
...
#if _SUPPORT_SUMA_DRM_
    int ret = 0, Tslen = TS_PACKET_SIZE;
	#ifdef _DEBUG_ANDROID_
//	LOGV("TS handle_packet packet");
	#endif
#endif
...
/*
 * Modify By Yen
 * decryption TS Stream
 * Add DRM
 */
#if _SUPPORT_SUMA_DRM_
	ret = suma_drm2hls_process_ts_packet(packet, &Tslen);
#ifdef _DEBUG_ANDROID_
	LOGV("ret = %d", ret);
#endif
#endif
