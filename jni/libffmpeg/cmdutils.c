...
const char program_name[] = "stainberg";
...
void show_help_children(const AVClass *class_byxjm, int flags)
{
    const AVClass *child = NULL;
    av_opt_show2(&class_byxjm, NULL, flags, 0);
    printf("\n");

    while (child = av_opt_child_class_next(class_byxjm, child))
...
int opt_loglevel(const char *opt, const char *arg)
{
    const struct { const char *name; int level; } log_levels[] = {
        ...
        { "debug"  , AV_LOG_DEBUG   },
#if 1 // added by xjm for drm log output
		{ "drm"    , AV_LOG_DRM     },
#endif
    };
    char *tail;
