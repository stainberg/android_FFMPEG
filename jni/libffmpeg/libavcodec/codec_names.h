// added by xjm
// 
// make 时由codec_namees.sh生成的，注意，需要make distclean清除干净后make
...
#endif
#if CONFIG_LJPEG_ENCODER // added by xjm for compile
case CODEC_ID_LJPEG:
...
#endif
#if CONFIG_H263P_ENCODER // added by xjm for compile
case CODEC_ID_H263P:
...
#endif
#if CONFIG_ZLIB_DECODER // added by xjm for compile
case CODEC_ID_ZLIB:
...
#endif
#if CONFIG_TSCC_DECODER // added by xjm for compile
case CODEC_ID_TSCC:
...
#endif
#if CONFIG_PNG_DECODER // added by xjm for compile
case CODEC_ID_PNG:
...
#endif
#if CONFIG_ZMBV_DECODER // added by xjm for compile
case CODEC_ID_ZMBV:
...
#endif
#if CONFIG_FLASHSV_DECODER // added by xjm for compile
...
#endif
#if CONFIG_VMNC_DECODER // added by xjm for compile
case CODEC_ID_VMNC:
...
#endif
#if CONFIG_DXA_DECODER // added by xjm for compile
case CODEC_ID_DXA:
...
#endif
#if CONFIG_FLASHSV2_DECODER // added by xjm for compile
...
#endif
#if CONFIG_XBM_DECODER // added by xjm for compile
case CODEC_ID_XBM:
    { extern AVCodec ff_xbm_decoder;
      return ff_xbm_decoder.name; }
#endif	  
#if CONFIG_ZEROCODEC_DECODER // added by xjm for compile
...
#endif
#if CONFIG_ADPCM_IMA_AMV_DECODER // added by xjm for compile
...
#endif
#if CONFIG_SONIC_ENCODER // added by xjm for compile
